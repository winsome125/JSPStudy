...
<body>
	...
	<!-- 
	이클립스에서는 우리가 직접 작성한 파일을 실행하지 않고 .metadata 디렉토리 하위에 프로젝트와 동일한 톰켓 환경을 만들어서 복사본 파일을 실행하게 된다.
	...
	*/
	public String useImplicitObject(){
		/*
		방법 1 
			: getServletContext() 메서드를 통해 선언부에서 application 내장객체를 얻어올 수 있다.
		*/
	...
	public String useImplicitObject(ServletContext app){
		/*
		방법 2
			: 스크립트릿에서 메서드를 호출할때 application 내장객체를 매개변수로 전달해서 사용한다.
		*/
