...
<!-- 
 ...
 -->
	...
	<h4>국,영,수 점수를 입력한 평균을 내어 학점 출력</h4>
	...
	<!-- 국,영,수 3과목 모두 점수를 입력해야하지만 조건에 만족하므로 하나라도 입력되지 않으면 평균점수는 출력되지 않는다. -->
	<c:if test="${ not (empty param.kor or empty param.eng or empty param.math) }">
		...
		<!--
		 ...
		 when태그는 if혹은 else if와 동일하고 otherwise는 else와 동일하다.
		-->
		<c:choose>
