...
<body>
	...
	<!-- 저장된 순서데로 Person객체를 변수 list에 저장 후 getter를 통해 멤버변수에 저장된 값을 출력한다. -->
		<li>
	...
	*/
	...
	<!-- Map컬렉션 사용시 Key를 별도로 얻어올 피료없이 객체.Key 혹은 객체.value를 통해 값을 출력할 수 있다. -->
	...
	for(String key : Keys) {
		...
		/* 
		 Key와 Value를 출력한다.
		 여기서 Value는 Perosn객체이므로 멤버변수에 저장된값은 getter를 통해 출력할 수 있다.
		*/
		out.println("Key => "+ key +"<br>");
		out.println("Value => "+ p.getName() +","+ p.getAge() +"<br>");
	}
	/* 
	 SJTL의 확장 for문을 사용하면 Key를 별도로 얻어와야 하는 번거로움이 없으므로 편리하다.
	*/
